    ...
    <nav className="bg-white navbar-shadow sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <ul className="hidden md:flex gap-8 text-slate-600 font-medium">
          <li><a href="<?= base_url('home') ?>" className="text-blue-600 font-semibold">Home</a></li>
      ...
      {menuOpen && (
        <div className="md:hidden bg-white border-t px-4 py-3 flex flex-col gap-3 text-slate-700 font-medium">
          <a href="<?= base_url('home') ?>" className="text-blue-600">Home</a>
...
function Hero() {
  return (
    <section className="hero-bg text-white py-24 px-4">
  ...
  return (
    <div className="bg-white rounded-2xl overflow-hidden shadow-sm card-hover border border-slate-100">
      <a href={`<?= base_url('detail') ?>/${product.id}`}>
        <div className="h-52 flex items-center justify-center bg-slate-50 p-4">
          <img
            src={product.image}
            alt={product.title}
...
function FeaturedProducts({ onAddCart }) {
  ...
  return (
    <section id="produk-unggulan" className="max-w-7xl mx-auto px-4 py-16">
...
function App() {
  ...
  const handleAddCart = (product) => {
    ...
    alert(`"${product.title.substring(0, 30)}..." ditambahkan ke keranjang!`);
  };
